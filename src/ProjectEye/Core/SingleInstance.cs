...
#if DEBUG
        private const string InstanceMutexName = "EyeProtectDebug_Unique_Application_Mutex";
#else
        private const string InstanceMutexName = "EyeProtect_Unique_Application_Mutex";
#endif
