...
namespace EyeProtect.Core.Service
{
    ...
    public class MainService : IService
    {
        ...
        private void HandleLanguageChanged()
        {
            ...
            {
                var language = new ResourceDictionary { Source = new Uri($"/EyeProtect;component{ResourcePaths.Languages.GetLanguagePath(config.options.Style.Language.Value)}", UriKind.RelativeOrAbsolute) };
                mds.Add(language);
            }
